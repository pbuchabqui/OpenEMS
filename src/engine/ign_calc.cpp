...
int16_t clamp_advance_deg(int16_t advance_deg) noexcept {
    ...
    // combustíveis com maior octanagem (ex.: E30). A tabela armazena graus
    // reais BTDC diretamente; o clamp protege contra valores excessivos.
    // Ajustar após calibração em bancada.
