...
#define GPIOA_OTYPER  STM32_REG32(GPIOA_BASE + GPIO_OTYPER_OFF)
...
#define GPIOB_OTYPER  STM32_REG32(GPIOB_BASE + GPIO_OTYPER_OFF)
...
#define GPIOB_PUPDR   STM32_REG32(GPIOB_BASE + GPIO_PUPDR_OFF)
#define GPIOB_BSRR    STM32_REG32(GPIOB_BASE + GPIO_BSRR_OFF)

#define GPIOC_MODER   STM32_REG32(GPIOC_BASE + GPIO_MODER_OFF)
#define GPIOC_OTYPER  STM32_REG32(GPIOC_BASE + GPIO_OTYPER_OFF)
...
#define GPIOE_OTYPER  STM32_REG32(GPIOE_BASE + GPIO_OTYPER_OFF)
#define GPIOE_OSPEEDR STM32_REG32(GPIOE_BASE + GPIO_OSPEEDR_OFF)
#define GPIOE_PUPDR   STM32_REG32(GPIOE_BASE + GPIO_PUPDR_OFF)
...
#define TIM3_DIER  STM32_REG32(TIM3_BASE + TIM_DIER_OFF)
...
// TIM15 — advanced timer (legacy PE5 on VGT6; RGT6 ETB uses TIM3_CH1/PA6)
...
#define ADC2_SQR2  STM32_REG32(ADC2_BASE + ADC_SQR2_OFF)
