...
// ADIV=1 (/2), MODE=11 (16-bit), ADICLK=00 (bus clock)
#define ADC_CFG1_16B_DIV2 (0x1u << 5) | (0x3u << 2)
// MUXSEL=0 (a)
#define ADC_CFG2_MUXA 0u

// PDB_SC: PDBEN, TRGSEL=8 (FTM3), LDOK
...
inline uint8_t adc0_code(ems::hal::Adc0Channel ch) noexcept {
    switch (ch) {
        case ems::hal::Adc0Channel::MAP_SE10:
            return 10u;
        case ems::hal::Adc0Channel::MAF_V_SE11:
            return 11u;
        case ems::hal::Adc0Channel::TPS_SE12:
            return 12u;
        case ems::hal::Adc0Channel::O2_SE4B:
            return 4u;
        case ems::hal::Adc0Channel::AN1_SE6B:
            return 6u;
        case ems::hal::Adc0Channel::AN2_SE7B:
            return 7u;
        case ems::hal::Adc0Channel::AN3_SE8B:
            return 8u;
        case ems::hal::Adc0Channel::AN4_SE9B:
            return 9u;
    }
    return 10u;
}
...
inline uint8_t adc1_code(ems::hal::Adc1Channel ch) noexcept {
    switch (ch) {
        case ems::hal::Adc1Channel::CLT_SE14:
            return 14u;
        case ems::hal::Adc1Channel::IAT_SE15:
            return 15u;
        case ems::hal::Adc1Channel::FUEL_PRESS_SE5B:
            return 5u;
        case ems::hal::Adc1Channel::OIL_PRESS_SE6B:
            return 6u;
    }
    return 14u;
}
...
void adc_init() noexcept {
    ...
    ADC0_CFG1 = ADC_CFG1_16B_DIV2;
    ADC0_CFG2 = ADC_CFG2_MUXA;
    ADC1_CFG1 = ADC_CFG1_16B_DIV2;
...
void adc_pdb_on_tooth(uint16_t tooth_period_ftm3_ticks) noexcept {
    const uint16_t mod = static_cast<uint16_t>(tooth_period_ftm3_ticks / 2u);
#if defined(EMS_HOST_TEST)
    g_last_pdb_mod = mod;
#else
