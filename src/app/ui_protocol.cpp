...
inline void update_realtime_page() noexcept {
    ...
    rt.reserved[6] = ems::drv::ckp_get_cmp_glitch_count() > 255u ? 255u
                     : static_cast<uint8_t>(ems::drv::ckp_get_cmp_glitch_count());
    rt.reserved[7] = ems::drv::ckp_get_phase_anchor_count();
